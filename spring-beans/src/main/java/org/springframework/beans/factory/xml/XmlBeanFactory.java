 ...
 *///zc 提供基于xml的最简单的IoC功能.初始化一个XmlBeanDefinitionReader对象处理xml方式定义的BeanDefinition.
@Deprecated
@SuppressWarnings({"serial", "all"})
public class XmlBeanFactory extends DefaultListableBeanFactory {
	//zc 读取xml 1.初始化XmlBeanDefinitionReader
	 ...
	 *///zc 需要用Resource指定xml文件位置,即指定BeanDefinition的信息来源
