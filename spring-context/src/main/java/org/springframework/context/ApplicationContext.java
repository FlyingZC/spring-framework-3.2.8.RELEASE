 ...
 *///zc ApplicationContext继承了BeanFactory接口体系中的ListableBeanFactory,AutoHierarchicalBeanFactory接口.又继承MessageSource,ApplicationEventPublisher.ApplicationContext接口继承ResourcePatternResolver接口,ResourcePatternResolver接口继承ResourceLoader接口.FileSystemXmlApplicationContext是该接口的一个实现
